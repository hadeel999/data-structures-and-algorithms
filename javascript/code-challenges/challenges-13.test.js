...
Write a function named firstLetters that takes in an array of strings and returns an array containing only the first letter of each 
string.
...
const firstLetters = (arr) => {
  // Solution code here...
  return arr.map(letter=>letter[0]);
};
...
const findHappiness = (arr) => {
  ...
  let result = arr.filter(element => {
    if ((value1.test(element)) || (value2.test(element)))
      return element;
  });
  return result;
};
...
Write a function named allHappy that takes in an array of strings and returns a Boolean indicating whether all those strings 
contain ":)".
------------------------------------------------------------------------------------------------ */
