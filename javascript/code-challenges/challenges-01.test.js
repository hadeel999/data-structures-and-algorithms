...
Write a function named addValues that takes in an array and a value and pushes the value into the array. This function does 
...
const fizzbuzz = (arr) => {
  ...
  let result=[];
  arr.forEach(element=>{
    (element%3==0&&element%5==0)?result.push("Fizz Buzz"):
    (element%3==0)? result.push("Fizz"):
    (element%5==0)? result.push("Buzz"):
    result.push(element);
  })
  return result;
};
