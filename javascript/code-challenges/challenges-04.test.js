...
const updateAnimal = (arr, callback) => {
  // Solution code here...
  let result= arr.map(element=>callback(element))
  return result;
};
...
const sortNames = (arr) => {
  // Solution code here...
  return arr.sort((elementOne, elementTwo) => elementOne < elementTwo ? -1 : 1);
};
...
const sortByPrice = (arr) => {
  // Solution code here...
  return arr.sort((elementOne,elementTwo)=>elementOne.price<elementTwo.price ? -1:1);
};
